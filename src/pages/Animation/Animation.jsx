...
function Animation() {
    ...
    return (
        <div className='animation-container'>
            <h1 className='animation-title neon-text'>Animation</h1>
            <div id="container">
                <div
                    id="field"
                    style={{ width: fieldWidth, height: fieldHeight, position: 'relative', border: '1px solid #ccc', borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}
                >
                    <div
                        id="ball"
                        style={{
                ...
                <div id="control">
                    <button className={`mx-3 btn ${running ? 'btn-danger' : 'btn-success'}`} onClick={runClick} id="run">
